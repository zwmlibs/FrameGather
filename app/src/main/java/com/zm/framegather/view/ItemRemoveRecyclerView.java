        ...
        switch (e.getAction()) {
            case MotionEvent.ACTION_DOWN:
                if (mDeleteBtnState == 0) {
                    ...
                    if (view == null || getChildViewHolder(view) instanceof RemoveItemAdapter.FootViewHolder) {
                        return false;
                    }

                    RemoveItemAdapter.MyViewHolder viewHolder = (RemoveItemAdapter.MyViewHolder) getChildViewHolder(view);
