...
public class MoveEffectAdjuster extends com.zm.framegather.view.SuperTextView.Adjuster {
  ...
  public void adjust(SuperTextView v, Canvas canvas) {
    ...
    paint.setColor(Color.rgb(104, 68, 211));
    canvas.drawRoundRect(rectF, height / 2, height / 2, paint);
    paint.setXfermode(xfermode);
    paint.setColor(Color.rgb(150, 124, 224));
